...
const OurPolicy = () => {
  return (
   ...
   <div>
    <img src={assets.exchange_icon} className='w-12 h-12 mx-auto mb-5' alt=""/>
    <p className='font-semibold'>Easy Exchange Policy</p>
    <p className='text-gray-400'>We offer a hassle-free exchange policy </p>
   </div>
    <div>
    <img src={assets.quality_icon} className='w-12 h-12 mx-auto mb-5' alt=""/>
    <p className='font-semibold'>7-Days Return Policy</p>
    <p className='text-gray-400'>We provide 7-days free return policy </p>
   </div>
    <div>
    <img src={assets.support_img} className='w-12 h-12 mx-auto mb-5' alt=""/>
